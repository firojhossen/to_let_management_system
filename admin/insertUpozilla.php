...
<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['dist'])){	
		...
		$insertDis = $user->insertUpozilla($_POST);
    ...
    <main class="app-content">
      ...
      <div class="row">         
		...
		<?php
			...
			?>	
          <div class="tile">
            <form action="" method="POST" style="background:white;padding: 10px 10px 10px 10px;">
				...
				<div class="form-group">	
					...
					<input type="text" id="" placeholder="Disabled input here..." name="uponame" class="form-control" style="max-width:500px;float:left"/>
              ...
              <tbody>
                <tr>
                  <td><?php echo $rs["id"]; ?></td>
					<?php $total = $user->upozillaPosts($rs["id"]); ?>
					<?php 
						$distId = $rs["districtid"];						
						
						$result=$user->getDistrictName($distId);
						 					
                       ?>        
                  <td><?php echo $result; ?></td>                 
                  <td><?php echo $rs["uponame"]; ?></td>                 
